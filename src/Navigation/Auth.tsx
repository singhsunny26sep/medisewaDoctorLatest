...
const Auth = (): React.JSX.Element => {
  return (
    <Stack.Navigator initialRouteName={NavigationString.Drawer}>
      ...
      />
      <Stack.Screen
        name={NavigationString.FindDoctor}
      ...
      />
      <Stack.Screen
        name={NavigationString.FindConcern}
        component={FindConcern}
        options={{
          headerShown: true,
          title: 'Find your Health Concern',
          headerStyle: {backgroundColor: colors.greenCustom},
          headerTintColor: colors.white,
          headerTitleStyle: {color: colors.white},
        }}
      />
      <Stack.Screen
        name={NavigationString.DoctorDetails}
      ...
      <Stack.Screen
        name={NavigationString.ProfileUpdate}
      ...
      />
      <Stack.Screen
        name={NavigationString.UploadPrecription}
        component={UploadPrecription}
        options={{
          headerShown: true,
          title: 'Upload Precription',
          headerStyle: {backgroundColor: colors.greenCustom},
          headerTintColor: colors.white,
          headerTitleStyle: {color: colors.white},
        }}
      />
      <Stack.Screen
        name={NavigationString.AllAppoinment}
        component={AllAppoinment}
        options={{
          headerShown: true,
          title: 'Appoinment',
          headerStyle: {backgroundColor: colors.greenCustom},
      ...
      />
      <Stack.Screen
        name={NavigationString.AllPatients}
      ...
      />
      <Stack.Screen
        name={NavigationString.ForgotPassword}
      ...
      />
      <Stack.Screen
        name={NavigationString.TimingSlot}
        component={TimingSlot}
        options={{
          headerShown: true,
          title: 'Timing Slot',
          headerStyle: {backgroundColor: colors.greenCustom},
