...
type CallContextType = {
  ...
  setIncoming: React.Dispatch<
    React.SetStateAction<RtmIncomingCallPayload | null | undefined>
  >;
      ...
      <View style={styles.modalContainer}>
        <View style={styles.card}>
          ...
          <Text style={styles.callLabel}>
            Incoming {formattedCallType} Call
          </Text>
  ...
  const onAccept = async () => {
    ...
    try {
      ...
      if (
        ...
        console.log('⚠️ Accept call response missing video credentials.');
      }
      setIncoming(null);
      setShowIncomingModal(false);
...
// ✅ FIXED STYLES – Modal always centered
const styles = StyleSheet.create({
  modalContainer: {
    flex: 1, // takes full screen
    backgroundColor: 'rgba(0,0,0,0.65)',
    alignItems: 'center',
    justifyContent: 'center', // centers content vertically & horizontally
    padding: 20,
  },
  card: {
    width: '85%',
